...
const values = {
  en: {
    ...
    4: 'Our commitment to personalized service sets us apart. We understand that each guest is unique, and we strive to cater to your individual needs and preferences. We are here to make your stay truly special.',
    5: 'PRIME LOCATION',
    6: 'S Princess Suite is ideally situated just 20 meters from the Aegean Sea in Nea Kallikratia, Chalkidiki. Our prime waterfront location offers direct access to pristine beaches, stunning sunsets, and various water activities, ensuring an unforgettable coastal getaway',
  },
  el: {
    1: 'Εξαιρετική Άνεση',
